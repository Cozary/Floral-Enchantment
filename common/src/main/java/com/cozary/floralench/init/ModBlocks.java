...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> CACTUS_FLOWER_VINE = BLOCKS.register("cactus_flower_vine", () -> VineBlockFactory.create("cactus_flower_vine"));
    public static final RegistryObject<Block> GOLDEN_DANDELION_VINE = BLOCKS.register("golden_dandelion_vine", () -> VineBlockFactory.create("golden_dandelion_vine"));
    ...
    public static final RegistryObject<Block> CACTUS_FLOWER_MOSSY_COBBLESTONE = BLOCKS.register("cactus_flower_mossy_cobblestone", () -> MossyBlockFactory.create("cactus_flower_mossy_cobblestone"));
    public static final RegistryObject<Block> GOLDEN_DANDELION_MOSSY_COBBLESTONE = BLOCKS.register("golden_dandelion_mossy_cobblestone", () -> MossyBlockFactory.create("golden_dandelion_mossy_cobblestone"));

    //Bush
    public static final RegistryObject<Block> ALLIUM_BUSH = BLOCKS.register("allium_bush", AlliumVineBushBlock::new);
    public static final RegistryObject<Block> AZURE_BLUET_BUSH = BLOCKS.register("azure_bluet_bush", AzureBluetVineBushBlock::new);
    public static final RegistryObject<Block> BLUE_ORCHID_BUSH = BLOCKS.register("blue_orchid_bush", BlueOrchidVineBushBlock::new);
    public static final RegistryObject<Block> CORNFLOWER_BUSH = BLOCKS.register("cornflower_bush", CornflowerVineBushBlock::new);
    public static final RegistryObject<Block> DANDELION_BUSH = BLOCKS.register("dandelion_bush", DandelionVineBushBlock::new);
    public static final RegistryObject<Block> LILAC_BUSH = BLOCKS.register("lilac_bush", LilacVineBushBlock::new);
    public static final RegistryObject<Block> LILY_OF_THE_VALLEY_BUSH = BLOCKS.register("lily_of_the_valley_bush", LilyOfTheValleyVineBushBlock::new);
    public static final RegistryObject<Block> ORANGE_TULIP_BUSH = BLOCKS.register("orange_tulip_bush", OrangeTulipVineBushBlock::new);
    public static final RegistryObject<Block> OXEYE_DAISY_BUSH = BLOCKS.register("oxeye_daisy_bush", OxeyeDaisyVineBushBlock::new);
    public static final RegistryObject<Block> PEONY_BUSH = BLOCKS.register("peony_bush", PeonyVineBushBlock::new);
    public static final RegistryObject<Block> PINK_TULIP_BUSH = BLOCKS.register("pink_tulip_bush", PinkTulipVineBushBlock::new);
    public static final RegistryObject<Block> POPPY_BUSH = BLOCKS.register("poppy_bush", PoppyVineBushBlock::new);
    public static final RegistryObject<Block> RED_TULIP_BUSH = BLOCKS.register("red_tulip_bush", RedTulipVineBushBlock::new);
    public static final RegistryObject<Block> ROSE_BUSH_BUSH = BLOCKS.register("rose_bush_bush", RoseBushVineBushBlock::new);
    public static final RegistryObject<Block> SUNFLOWER_BUSH = BLOCKS.register("sunflower_bush", SunflowerVineBushBlock::new);
    public static final RegistryObject<Block> WHITE_TULIP_BUSH = BLOCKS.register("white_tulip_bush", WhiteTulipVineBushBlock::new);
    public static final RegistryObject<Block> WITHER_ROSE_BUSH = BLOCKS.register("wither_rose_bush", WitherVineBushBlock::new);
    public static final RegistryObject<Block> TORCHFLOWER_BUSH = BLOCKS.register("torchflower_bush", TorchflowerVineBushBlock::new);
    public static final RegistryObject<Block> PITCHER_PLANT_BUSH = BLOCKS.register("pitcher_plant_bush", PitcherPlantVineBushBlock::new);
    public static final RegistryObject<Block> CHORUS_FLOWER_BUSH = BLOCKS.register("chorus_flower_bush", ChorusFlowerVineBushBlock::new);
    public static final RegistryObject<Block> AZALEA_BUSH = BLOCKS.register("azalea_bush", AzaleaVineBushBlock::new);
    public static final RegistryObject<Block> PINK_PETALS_BUSH = BLOCKS.register("pink_petals_bush", PinkPetalsVineBushBlock::new);
    public static final RegistryObject<Block> SPORE_BLOSSOM_BUSH = BLOCKS.register("spore_blossom_bush", SporeBlossomVineBushBlock::new);
    public static final RegistryObject<Block> OPEN_EYEBLOSSOM_BUSH = BLOCKS.register("open_eyeblossom_bush", () -> new EyeblossomVineBushBlock(EyeblossomVineBushBlock.Type.OPEN));
    public static final RegistryObject<Block> CLOSED_EYEBLOSSOM_BUSH = BLOCKS.register("closed_eyeblossom_bush", () -> new EyeblossomVineBushBlock(EyeblossomVineBushBlock.Type.CLOSED));
    public static final RegistryObject<Block> WILDFLOWERS_BUSH = BLOCKS.register("wildflowers_bush", WildflowersVineBushBlock::new);
    public static final RegistryObject<Block> CACTUS_FLOWER_BUSH = BLOCKS.register("cactus_flower_bush", CactusFlowerVineBushBlock::new);
    public static final RegistryObject<Block> GOLDEN_DANDELION_BUSH = BLOCKS.register("golden_dandelion_bush", GoldenDandelionVineBushBlock::new);
    ...
    public static final RegistryObject<Block> CACTUS_FLOWER_MOSSY_STONE_BRICK = BLOCKS.register("cactus_flower_mossy_stone_brick", () -> MossyStoneBricksBlockFactory.create("cactus_flower_mossy_stone_brick"));
    public static final RegistryObject<Block> GOLDEN_DANDELION_MOSSY_STONE_BRICK = BLOCKS.register("golden_dandelion_mossy_stone_brick", () -> MossyStoneBricksBlockFactory.create("golden_dandelion_mossy_stone_brick"));
    ...
    public static final RegistryObject<Block> LARGE_CACTUS_FLOWER_POT = BLOCKS.register("large_cactus_flower_pot", LargeCactusFlowerPot::new);
    public static final RegistryObject<Block> LARGE_GOLDEN_DANDELION_POT = BLOCKS.register("large_golden_dandelion_pot", LargeGoldenDandelionPot::new);
    ...
    public static final RegistryObject<Block> LARGE_DOUBLE_CACTUS_FLOWER_POT = BLOCKS.register("large_double_cactus_flower_pot", LargeDoubleCactusFlowerPot::new);
    public static final RegistryObject<Block> LARGE_DOUBLE_GOLDEN_DANDELION_POT = BLOCKS.register("large_double_golden_dandelion_pot", LargeDoubleGoldenDandelionPot::new);
    ...
    public static final RegistryObject<Block> CACTUS_FLOWER_BASKET = BLOCKS.register("cactus_flower_basket", () -> FloralBasketFactory.create("cactus_flower_basket"));
    public static final RegistryObject<Block> GOLDEN_DANDELION_BASKET = BLOCKS.register("golden_dandelion_basket", () -> FloralBasketFactory.create("golden_dandelion_basket"));
