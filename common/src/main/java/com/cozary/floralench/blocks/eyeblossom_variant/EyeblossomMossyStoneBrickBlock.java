...
public class EyeblossomMossyStoneBrickBlock extends MossyStoneBrickBlock {
    ...
    public EyeblossomMossyStoneBrickBlock(Boolean open) {
        super("eyeblossom_mossy_stone_bricks");
        this.type = EyeblossomMossyStoneBrickBlock.Type.fromBoolean(open);
    ...
    private boolean tryChangingState(BlockState state, ServerLevel level, BlockPos pos, RandomSource random) {
        ...
        if (flag == this.type.open) {
            ...
            EyeblossomMossyStoneBrickBlock.Type eyeblossomblock$type = this.type.transform();
    ...
    public static enum Type {
        ...
        public EyeblossomMossyStoneBrickBlock.Type transform() {
