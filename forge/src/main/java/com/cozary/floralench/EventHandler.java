...
public class EventHandler {
    ...
    @OnlyIn(Dist.CLIENT)
    @SubscribeEvent
    public void renderHeldPot(RenderPlayerEvent.Pre event) {
    ...
    @OnlyIn(Dist.CLIENT)
    @SubscribeEvent
    public void holdPotPost(RenderPlayerEvent.Post event) {
        Player player = event.getEntity();
    ...
    @OnlyIn(Dist.CLIENT)
    private void renderArmModelHoldingPot(PlayerModel<AbstractClientPlayer> model, Player player, RenderPlayerEvent event) {
